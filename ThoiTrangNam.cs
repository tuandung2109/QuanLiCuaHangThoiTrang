...
{
    public partial class ThoiTrangNam : Form
    {
        public ThoiTrangNam()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT MaSanPham, TenSanPham, LoaiSanPham, KichCo, Gia, HangSanXuat FROM ThoiTrangNam";
        ...
        private void ThoiTrangNam_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO ThoiTrangNam (TenSanPham, LoaiSanPham, KichCo, Gia, HangSanXuat) " +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "UPDATE ThoiTrangNam SET TenSanPham=@TenSanPham, LoaiSanPham=@LoaiSanPham, " +
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "DELETE FROM ThoiTrangNam WHERE MaSanPham = @MaSanPham";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT MaSanPham, TenSanPham, LoaiSanPham, KichCo, Gia, HangSanXuat FROM ThoiTrangNam WHERE MaSanPham = @MaSanPham";
                    SqlDataAdapter dataAdapter = new SqlDataAdapter(query, conn);
